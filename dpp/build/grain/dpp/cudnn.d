...
extern(C)
{
    ...
    enum CUDNN_PTR_XDATA = _Anonymous_13.CUDNN_PTR_XDATA;
    enum CUDNN_PTR_BN_EQSCALE = _Anonymous_13.CUDNN_PTR_BN_EQSCALE;
    enum CUDNN_PTR_BN_EQBIAS = _Anonymous_13.CUDNN_PTR_BN_EQBIAS;
    enum CUDNN_PTR_WDATA = _Anonymous_13.CUDNN_PTR_WDATA;
    enum CUDNN_PTR_DWDATA = _Anonymous_13.CUDNN_PTR_DWDATA;
    enum CUDNN_PTR_YDATA = _Anonymous_13.CUDNN_PTR_YDATA;
    enum CUDNN_PTR_DYDATA = _Anonymous_13.CUDNN_PTR_DYDATA;
    enum CUDNN_PTR_YSUM = _Anonymous_13.CUDNN_PTR_YSUM;
    enum CUDNN_PTR_YSQSUM = _Anonymous_13.CUDNN_PTR_YSQSUM;
    enum CUDNN_PTR_WORKSPACE = _Anonymous_13.CUDNN_PTR_WORKSPACE;
    enum CUDNN_PTR_BN_SCALE = _Anonymous_13.CUDNN_PTR_BN_SCALE;
    enum CUDNN_PTR_BN_BIAS = _Anonymous_13.CUDNN_PTR_BN_BIAS;
    enum CUDNN_PTR_BN_SAVED_MEAN = _Anonymous_13.CUDNN_PTR_BN_SAVED_MEAN;
    enum CUDNN_PTR_BN_SAVED_INVSTD = _Anonymous_13.CUDNN_PTR_BN_SAVED_INVSTD;
    enum CUDNN_PTR_BN_RUNNING_MEAN = _Anonymous_13.CUDNN_PTR_BN_RUNNING_MEAN;
    enum CUDNN_PTR_BN_RUNNING_VAR = _Anonymous_13.CUDNN_PTR_BN_RUNNING_VAR;
    enum CUDNN_PTR_ZDATA = _Anonymous_13.CUDNN_PTR_ZDATA;
    enum CUDNN_PTR_BN_Z_EQSCALE = _Anonymous_13.CUDNN_PTR_BN_Z_EQSCALE;
    enum CUDNN_PTR_BN_Z_EQBIAS = _Anonymous_13.CUDNN_PTR_BN_Z_EQBIAS;
    enum CUDNN_PTR_ACTIVATION_BITMASK = _Anonymous_13.CUDNN_PTR_ACTIVATION_BITMASK;
    enum CUDNN_PTR_DXDATA = _Anonymous_13.CUDNN_PTR_DXDATA;
    enum CUDNN_PTR_DZDATA = _Anonymous_13.CUDNN_PTR_DZDATA;
    enum CUDNN_PTR_BN_DSCALE = _Anonymous_13.CUDNN_PTR_BN_DSCALE;
    enum CUDNN_PTR_BN_DBIAS = _Anonymous_13.CUDNN_PTR_BN_DBIAS;
    enum CUDNN_SCALAR_SIZE_T_WORKSPACE_SIZE_IN_BYTES = _Anonymous_13.CUDNN_SCALAR_SIZE_T_WORKSPACE_SIZE_IN_BYTES;
    enum CUDNN_SCALAR_INT64_T_BN_ACCUMULATION_COUNT = _Anonymous_13.CUDNN_SCALAR_INT64_T_BN_ACCUMULATION_COUNT;
    enum CUDNN_SCALAR_DOUBLE_BN_EXP_AVG_FACTOR = _Anonymous_13.CUDNN_SCALAR_DOUBLE_BN_EXP_AVG_FACTOR;
    enum CUDNN_SCALAR_DOUBLE_BN_EPSILON = _Anonymous_13.CUDNN_SCALAR_DOUBLE_BN_EPSILON;
    alias cudnnFusedOpsVariantParamLabel_t = _Anonymous_13;
    enum _Anonymous_14
    {
        CUDNN_PTR_NULL = 0,
    ...
    enum CUDNN_PTR_NULL = _Anonymous_14.CUDNN_PTR_NULL;
    enum CUDNN_PTR_ELEM_ALIGNED = _Anonymous_14.CUDNN_PTR_ELEM_ALIGNED;
    enum CUDNN_PTR_16B_ALIGNED = _Anonymous_14.CUDNN_PTR_16B_ALIGNED;
    alias cudnnFusedOpsPointerPlaceHolder_t = _Anonymous_14;
    enum _Anonymous_15
    {
        CUDNN_PARAM_XDESC = 0,
    ...
    enum CUDNN_PARAM_XDESC = _Anonymous_15.CUDNN_PARAM_XDESC;
    enum CUDNN_PARAM_XDATA_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_XDATA_PLACEHOLDER;
    enum CUDNN_PARAM_BN_MODE = _Anonymous_15.CUDNN_PARAM_BN_MODE;
    enum CUDNN_PARAM_BN_EQSCALEBIAS_DESC = _Anonymous_15.CUDNN_PARAM_BN_EQSCALEBIAS_DESC;
    enum CUDNN_PARAM_BN_EQSCALE_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_EQSCALE_PLACEHOLDER;
    enum CUDNN_PARAM_BN_EQBIAS_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_EQBIAS_PLACEHOLDER;
    enum CUDNN_PARAM_ACTIVATION_DESC = _Anonymous_15.CUDNN_PARAM_ACTIVATION_DESC;
    enum CUDNN_PARAM_CONV_DESC = _Anonymous_15.CUDNN_PARAM_CONV_DESC;
    enum CUDNN_PARAM_WDESC = _Anonymous_15.CUDNN_PARAM_WDESC;
    enum CUDNN_PARAM_WDATA_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_WDATA_PLACEHOLDER;
    enum CUDNN_PARAM_DWDESC = _Anonymous_15.CUDNN_PARAM_DWDESC;
    enum CUDNN_PARAM_DWDATA_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_DWDATA_PLACEHOLDER;
    enum CUDNN_PARAM_YDESC = _Anonymous_15.CUDNN_PARAM_YDESC;
    enum CUDNN_PARAM_YDATA_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_YDATA_PLACEHOLDER;
    enum CUDNN_PARAM_DYDESC = _Anonymous_15.CUDNN_PARAM_DYDESC;
    enum CUDNN_PARAM_DYDATA_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_DYDATA_PLACEHOLDER;
    enum CUDNN_PARAM_YSTATS_DESC = _Anonymous_15.CUDNN_PARAM_YSTATS_DESC;
    enum CUDNN_PARAM_YSUM_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_YSUM_PLACEHOLDER;
    enum CUDNN_PARAM_YSQSUM_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_YSQSUM_PLACEHOLDER;
    enum CUDNN_PARAM_BN_SCALEBIAS_MEANVAR_DESC = _Anonymous_15.CUDNN_PARAM_BN_SCALEBIAS_MEANVAR_DESC;
    enum CUDNN_PARAM_BN_SCALE_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_SCALE_PLACEHOLDER;
    enum CUDNN_PARAM_BN_BIAS_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_BIAS_PLACEHOLDER;
    enum CUDNN_PARAM_BN_SAVED_MEAN_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_SAVED_MEAN_PLACEHOLDER;
    enum CUDNN_PARAM_BN_SAVED_INVSTD_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_SAVED_INVSTD_PLACEHOLDER;
    enum CUDNN_PARAM_BN_RUNNING_MEAN_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_RUNNING_MEAN_PLACEHOLDER;
    enum CUDNN_PARAM_BN_RUNNING_VAR_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_RUNNING_VAR_PLACEHOLDER;
    enum CUDNN_PARAM_ZDESC = _Anonymous_15.CUDNN_PARAM_ZDESC;
    enum CUDNN_PARAM_ZDATA_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_ZDATA_PLACEHOLDER;
    enum CUDNN_PARAM_BN_Z_EQSCALEBIAS_DESC = _Anonymous_15.CUDNN_PARAM_BN_Z_EQSCALEBIAS_DESC;
    enum CUDNN_PARAM_BN_Z_EQSCALE_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_Z_EQSCALE_PLACEHOLDER;
    enum CUDNN_PARAM_BN_Z_EQBIAS_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_Z_EQBIAS_PLACEHOLDER;
    enum CUDNN_PARAM_ACTIVATION_BITMASK_DESC = _Anonymous_15.CUDNN_PARAM_ACTIVATION_BITMASK_DESC;
    enum CUDNN_PARAM_ACTIVATION_BITMASK_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_ACTIVATION_BITMASK_PLACEHOLDER;
    enum CUDNN_PARAM_DXDESC = _Anonymous_15.CUDNN_PARAM_DXDESC;
    enum CUDNN_PARAM_DXDATA_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_DXDATA_PLACEHOLDER;
    enum CUDNN_PARAM_DZDESC = _Anonymous_15.CUDNN_PARAM_DZDESC;
    enum CUDNN_PARAM_DZDATA_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_DZDATA_PLACEHOLDER;
    enum CUDNN_PARAM_BN_DSCALE_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_DSCALE_PLACEHOLDER;
    enum CUDNN_PARAM_BN_DBIAS_PLACEHOLDER = _Anonymous_15.CUDNN_PARAM_BN_DBIAS_PLACEHOLDER;
    alias cudnnFusedOpsConstParamLabel_t = _Anonymous_15;
    enum _Anonymous_16
    {
    ...
    enum CUDNN_FUSED_SCALE_BIAS_ACTIVATION_CONV_BNSTATS = _Anonymous_16.CUDNN_FUSED_SCALE_BIAS_ACTIVATION_CONV_BNSTATS;
    enum CUDNN_FUSED_SCALE_BIAS_ACTIVATION_WGRAD = _Anonymous_16.CUDNN_FUSED_SCALE_BIAS_ACTIVATION_WGRAD;
    enum CUDNN_FUSED_BN_FINALIZE_STATISTICS_TRAINING = _Anonymous_16.CUDNN_FUSED_BN_FINALIZE_STATISTICS_TRAINING;
    enum CUDNN_FUSED_BN_FINALIZE_STATISTICS_INFERENCE = _Anonymous_16.CUDNN_FUSED_BN_FINALIZE_STATISTICS_INFERENCE;
    enum CUDNN_FUSED_CONV_SCALE_BIAS_ADD_ACTIVATION = _Anonymous_16.CUDNN_FUSED_CONV_SCALE_BIAS_ADD_ACTIVATION;
    enum CUDNN_FUSED_SCALE_BIAS_ADD_ACTIVATION_GEN_BITMASK = _Anonymous_16.CUDNN_FUSED_SCALE_BIAS_ADD_ACTIVATION_GEN_BITMASK;
    enum CUDNN_FUSED_DACTIVATION_FORK_DBATCHNORM = _Anonymous_16.CUDNN_FUSED_DACTIVATION_FORK_DBATCHNORM;
    alias cudnnFusedOps_t = _Anonymous_16;
    ...
    enum CUDNN_SEV_FATAL = _Anonymous_17.CUDNN_SEV_FATAL;
    enum CUDNN_SEV_ERROR = _Anonymous_17.CUDNN_SEV_ERROR;
    enum CUDNN_SEV_WARNING = _Anonymous_17.CUDNN_SEV_WARNING;
    enum CUDNN_SEV_INFO = _Anonymous_17.CUDNN_SEV_INFO;
    alias cudnnSeverity_t = _Anonymous_17;
    ...
    enum CUDNN_LOSS_NORMALIZATION_NONE = _Anonymous_18.CUDNN_LOSS_NORMALIZATION_NONE;
    enum CUDNN_LOSS_NORMALIZATION_SOFTMAX = _Anonymous_18.CUDNN_LOSS_NORMALIZATION_SOFTMAX;
    alias cudnnLossNormalizationMode_t = _Anonymous_18;
    enum _Anonymous_19
    {
        CUDNN_CTC_LOSS_ALGO_DETERMINISTIC = 0,
        CUDNN_CTC_LOSS_ALGO_NON_DETERMINISTIC = 1,
    }
    enum CUDNN_CTC_LOSS_ALGO_DETERMINISTIC = _Anonymous_19.CUDNN_CTC_LOSS_ALGO_DETERMINISTIC;
    enum CUDNN_CTC_LOSS_ALGO_NON_DETERMINISTIC = _Anonymous_19.CUDNN_CTC_LOSS_ALGO_NON_DETERMINISTIC;
    alias cudnnCTCLossAlgo_t = _Anonymous_19;
    ...
    enum CUDNN_WGRAD_MODE_ADD = _Anonymous_20.CUDNN_WGRAD_MODE_ADD;
    enum CUDNN_WGRAD_MODE_SET = _Anonymous_20.CUDNN_WGRAD_MODE_SET;
    alias cudnnWgradMode_t = _Anonymous_20;
    ...
    enum CUDNN_MH_ATTN_Q_WEIGHTS = _Anonymous_21.CUDNN_MH_ATTN_Q_WEIGHTS;
    enum CUDNN_MH_ATTN_K_WEIGHTS = _Anonymous_21.CUDNN_MH_ATTN_K_WEIGHTS;
    enum CUDNN_MH_ATTN_V_WEIGHTS = _Anonymous_21.CUDNN_MH_ATTN_V_WEIGHTS;
    enum CUDNN_MH_ATTN_O_WEIGHTS = _Anonymous_21.CUDNN_MH_ATTN_O_WEIGHTS;
    alias cudnnMultiHeadAttnWeightKind_t = _Anonymous_21;
    ...
    cudnnStatus_t cudnnGetAttnDescriptor(cudnnAttnStruct*, cudnnAttnQueryMap_t*, int*, double*, cudnnDataType_t*, cudnnDataType_t*, cudnnMathType_t*, cudnnDropoutStruct**, cudnnDropoutStruct**, int*, int*, int*, int*, int*, int*, int*, int*, int*, int*, int*) @nogc nothrow;
    cudnnStatus_t cudnnSetAttnDescriptor(cudnnAttnStruct*, cudnnAttnQueryMap_t, int, double, cudnnDataType_t, cudnnDataType_t, cudnnMathType_t, cudnnDropoutStruct*, cudnnDropoutStruct*, int, int, int, int, int, int, int, int, int, int, int) @nogc nothrow;
    ...
    alias cudnnStatus_t = _Anonymous_22;
    enum _Anonymous_22
    {
    ...
    enum CUDNN_STATUS_SUCCESS = _Anonymous_22.CUDNN_STATUS_SUCCESS;
    enum CUDNN_STATUS_NOT_INITIALIZED = _Anonymous_22.CUDNN_STATUS_NOT_INITIALIZED;
    enum CUDNN_STATUS_ALLOC_FAILED = _Anonymous_22.CUDNN_STATUS_ALLOC_FAILED;
    enum CUDNN_STATUS_BAD_PARAM = _Anonymous_22.CUDNN_STATUS_BAD_PARAM;
    enum CUDNN_STATUS_INTERNAL_ERROR = _Anonymous_22.CUDNN_STATUS_INTERNAL_ERROR;
    enum CUDNN_STATUS_INVALID_VALUE = _Anonymous_22.CUDNN_STATUS_INVALID_VALUE;
    enum CUDNN_STATUS_ARCH_MISMATCH = _Anonymous_22.CUDNN_STATUS_ARCH_MISMATCH;
    enum CUDNN_STATUS_MAPPING_ERROR = _Anonymous_22.CUDNN_STATUS_MAPPING_ERROR;
    enum CUDNN_STATUS_EXECUTION_FAILED = _Anonymous_22.CUDNN_STATUS_EXECUTION_FAILED;
    enum CUDNN_STATUS_NOT_SUPPORTED = _Anonymous_22.CUDNN_STATUS_NOT_SUPPORTED;
    enum CUDNN_STATUS_LICENSE_ERROR = _Anonymous_22.CUDNN_STATUS_LICENSE_ERROR;
    enum CUDNN_STATUS_RUNTIME_PREREQUISITE_MISSING = _Anonymous_22.CUDNN_STATUS_RUNTIME_PREREQUISITE_MISSING;
    enum CUDNN_STATUS_RUNTIME_IN_PROGRESS = _Anonymous_22.CUDNN_STATUS_RUNTIME_IN_PROGRESS;
    enum CUDNN_STATUS_RUNTIME_FP_OVERFLOW = _Anonymous_22.CUDNN_STATUS_RUNTIME_FP_OVERFLOW;
    const(char)* cudnnGetErrorString(cudnnStatus_t) @nogc nothrow;
    struct cudnnRuntimeTag_t;
    alias cudnnErrQueryMode_t = _Anonymous_23;
    enum _Anonymous_23
    {
    ...
    enum CUDNN_ERRQUERY_RAWCODE = _Anonymous_23.CUDNN_ERRQUERY_RAWCODE;
    enum CUDNN_ERRQUERY_NONBLOCKING = _Anonymous_23.CUDNN_ERRQUERY_NONBLOCKING;
    enum CUDNN_ERRQUERY_BLOCKING = _Anonymous_23.CUDNN_ERRQUERY_BLOCKING;
    ...
    alias cudnnDataType_t = _Anonymous_24;
    enum _Anonymous_24
    {
        CUDNN_DATA_FLOAT = 0,
        CUDNN_DATA_DOUBLE = 1,
    ...
    enum CUDNN_DATA_FLOAT = _Anonymous_24.CUDNN_DATA_FLOAT;
    enum CUDNN_DATA_DOUBLE = _Anonymous_24.CUDNN_DATA_DOUBLE;
    enum CUDNN_DATA_HALF = _Anonymous_24.CUDNN_DATA_HALF;
    enum CUDNN_DATA_INT8 = _Anonymous_24.CUDNN_DATA_INT8;
    enum CUDNN_DATA_INT32 = _Anonymous_24.CUDNN_DATA_INT32;
    enum CUDNN_DATA_INT8x4 = _Anonymous_24.CUDNN_DATA_INT8x4;
    enum CUDNN_DATA_UINT8 = _Anonymous_24.CUDNN_DATA_UINT8;
    enum CUDNN_DATA_UINT8x4 = _Anonymous_24.CUDNN_DATA_UINT8x4;
    enum CUDNN_DATA_INT8x32 = _Anonymous_24.CUDNN_DATA_INT8x32;
    alias cudnnMathType_t = _Anonymous_25;
    enum _Anonymous_25
    {
    ...
    enum CUDNN_DEFAULT_MATH = _Anonymous_25.CUDNN_DEFAULT_MATH;
    enum CUDNN_TENSOR_OP_MATH = _Anonymous_25.CUDNN_TENSOR_OP_MATH;
    enum CUDNN_TENSOR_OP_MATH_ALLOW_CONVERSION = _Anonymous_25.CUDNN_TENSOR_OP_MATH_ALLOW_CONVERSION;
    alias cudnnNanPropagation_t = _Anonymous_26;
    enum _Anonymous_26
    {
        CUDNN_NOT_PROPAGATE_NAN = 0,
        CUDNN_PROPAGATE_NAN = 1,
    }
    enum CUDNN_NOT_PROPAGATE_NAN = _Anonymous_26.CUDNN_NOT_PROPAGATE_NAN;
    enum CUDNN_PROPAGATE_NAN = _Anonymous_26.CUDNN_PROPAGATE_NAN;
    alias cudnnDeterminism_t = _Anonymous_27;
    enum _Anonymous_27
    {
        CUDNN_NON_DETERMINISTIC = 0,
        CUDNN_DETERMINISTIC = 1,
    }
    enum CUDNN_NON_DETERMINISTIC = _Anonymous_27.CUDNN_NON_DETERMINISTIC;
    enum CUDNN_DETERMINISTIC = _Anonymous_27.CUDNN_DETERMINISTIC;
    alias cudnnReorderType_t = _Anonymous_28;
    enum _Anonymous_28
    {
        CUDNN_DEFAULT_REORDER = 0,
        CUDNN_NO_REORDER = 1,
    }
    enum CUDNN_DEFAULT_REORDER = _Anonymous_28.CUDNN_DEFAULT_REORDER;
    enum CUDNN_NO_REORDER = _Anonymous_28.CUDNN_NO_REORDER;
    cudnnStatus_t cudnnCreateTensorDescriptor(cudnnTensorStruct**) @nogc nothrow;
    alias cudnnTensorFormat_t = _Anonymous_29;
    enum _Anonymous_29
    {
        CUDNN_TENSOR_NCHW = 0,
        CUDNN_TENSOR_NHWC = 1,
    ...
    enum CUDNN_TENSOR_NCHW = _Anonymous_29.CUDNN_TENSOR_NCHW;
    enum CUDNN_TENSOR_NHWC = _Anonymous_29.CUDNN_TENSOR_NHWC;
    enum CUDNN_TENSOR_NCHW_VECT_C = _Anonymous_29.CUDNN_TENSOR_NCHW_VECT_C;
    ...
    alias cudnnFoldingDirection_t = _Anonymous_30;
    enum _Anonymous_30
    {
        CUDNN_TRANSFORM_FOLD = 0,
        CUDNN_TRANSFORM_UNFOLD = 1,
    }
    enum CUDNN_TRANSFORM_FOLD = _Anonymous_30.CUDNN_TRANSFORM_FOLD;
    enum CUDNN_TRANSFORM_UNFOLD = _Anonymous_30.CUDNN_TRANSFORM_UNFOLD;
    ...
    alias cudnnOpTensorOp_t = _Anonymous_31;
    enum _Anonymous_31
    {
    ...
    enum CUDNN_OP_TENSOR_ADD = _Anonymous_31.CUDNN_OP_TENSOR_ADD;
    enum CUDNN_OP_TENSOR_MUL = _Anonymous_31.CUDNN_OP_TENSOR_MUL;
    enum CUDNN_OP_TENSOR_MIN = _Anonymous_31.CUDNN_OP_TENSOR_MIN;
    enum CUDNN_OP_TENSOR_MAX = _Anonymous_31.CUDNN_OP_TENSOR_MAX;
    enum CUDNN_OP_TENSOR_SQRT = _Anonymous_31.CUDNN_OP_TENSOR_SQRT;
    enum CUDNN_OP_TENSOR_NOT = _Anonymous_31.CUDNN_OP_TENSOR_NOT;
    ...
    alias cudnnReduceTensorOp_t = _Anonymous_32;
    enum _Anonymous_32
    {
    ...
    enum CUDNN_REDUCE_TENSOR_ADD = _Anonymous_32.CUDNN_REDUCE_TENSOR_ADD;
    enum CUDNN_REDUCE_TENSOR_MUL = _Anonymous_32.CUDNN_REDUCE_TENSOR_MUL;
    enum CUDNN_REDUCE_TENSOR_MIN = _Anonymous_32.CUDNN_REDUCE_TENSOR_MIN;
    enum CUDNN_REDUCE_TENSOR_MAX = _Anonymous_32.CUDNN_REDUCE_TENSOR_MAX;
    enum CUDNN_REDUCE_TENSOR_AMAX = _Anonymous_32.CUDNN_REDUCE_TENSOR_AMAX;
    enum CUDNN_REDUCE_TENSOR_AVG = _Anonymous_32.CUDNN_REDUCE_TENSOR_AVG;
    enum CUDNN_REDUCE_TENSOR_NORM1 = _Anonymous_32.CUDNN_REDUCE_TENSOR_NORM1;
    enum CUDNN_REDUCE_TENSOR_NORM2 = _Anonymous_32.CUDNN_REDUCE_TENSOR_NORM2;
    enum CUDNN_REDUCE_TENSOR_MUL_NO_ZEROS = _Anonymous_32.CUDNN_REDUCE_TENSOR_MUL_NO_ZEROS;
    alias cudnnReduceTensorIndices_t = _Anonymous_33;
    enum _Anonymous_33
    {
        CUDNN_REDUCE_TENSOR_NO_INDICES = 0,
        CUDNN_REDUCE_TENSOR_FLATTENED_INDICES = 1,
    }
    enum CUDNN_REDUCE_TENSOR_NO_INDICES = _Anonymous_33.CUDNN_REDUCE_TENSOR_NO_INDICES;
    enum CUDNN_REDUCE_TENSOR_FLATTENED_INDICES = _Anonymous_33.CUDNN_REDUCE_TENSOR_FLATTENED_INDICES;
    alias cudnnIndicesType_t = _Anonymous_34;
    enum _Anonymous_34
    {
    ...
    enum CUDNN_32BIT_INDICES = _Anonymous_34.CUDNN_32BIT_INDICES;
    enum CUDNN_64BIT_INDICES = _Anonymous_34.CUDNN_64BIT_INDICES;
    enum CUDNN_16BIT_INDICES = _Anonymous_34.CUDNN_16BIT_INDICES;
    enum CUDNN_8BIT_INDICES = _Anonymous_34.CUDNN_8BIT_INDICES;
    ...
    alias cudnnConvolutionMode_t = _Anonymous_35;
    enum _Anonymous_35
    {
        CUDNN_CONVOLUTION = 0,
        CUDNN_CROSS_CORRELATION = 1,
    }
    enum CUDNN_CONVOLUTION = _Anonymous_35.CUDNN_CONVOLUTION;
    enum CUDNN_CROSS_CORRELATION = _Anonymous_35.CUDNN_CROSS_CORRELATION;
    ...
    alias cudnnConvolutionFwdPreference_t = _Anonymous_36;
    enum _Anonymous_36
    {
    ...
    enum CUDNN_CONVOLUTION_FWD_NO_WORKSPACE = _Anonymous_36.CUDNN_CONVOLUTION_FWD_NO_WORKSPACE;
    enum CUDNN_CONVOLUTION_FWD_PREFER_FASTEST = _Anonymous_36.CUDNN_CONVOLUTION_FWD_PREFER_FASTEST;
    enum CUDNN_CONVOLUTION_FWD_SPECIFY_WORKSPACE_LIMIT = _Anonymous_36.CUDNN_CONVOLUTION_FWD_SPECIFY_WORKSPACE_LIMIT;
    alias cudnnConvolutionFwdAlgo_t = _Anonymous_37;
    enum _Anonymous_37
    {
    ...
    enum CUDNN_CONVOLUTION_FWD_ALGO_IMPLICIT_GEMM = _Anonymous_37.CUDNN_CONVOLUTION_FWD_ALGO_IMPLICIT_GEMM;
    enum CUDNN_CONVOLUTION_FWD_ALGO_IMPLICIT_PRECOMP_GEMM = _Anonymous_37.CUDNN_CONVOLUTION_FWD_ALGO_IMPLICIT_PRECOMP_GEMM;
    enum CUDNN_CONVOLUTION_FWD_ALGO_GEMM = _Anonymous_37.CUDNN_CONVOLUTION_FWD_ALGO_GEMM;
    enum CUDNN_CONVOLUTION_FWD_ALGO_DIRECT = _Anonymous_37.CUDNN_CONVOLUTION_FWD_ALGO_DIRECT;
    enum CUDNN_CONVOLUTION_FWD_ALGO_FFT = _Anonymous_37.CUDNN_CONVOLUTION_FWD_ALGO_FFT;
    enum CUDNN_CONVOLUTION_FWD_ALGO_FFT_TILING = _Anonymous_37.CUDNN_CONVOLUTION_FWD_ALGO_FFT_TILING;
    enum CUDNN_CONVOLUTION_FWD_ALGO_WINOGRAD = _Anonymous_37.CUDNN_CONVOLUTION_FWD_ALGO_WINOGRAD;
    enum CUDNN_CONVOLUTION_FWD_ALGO_WINOGRAD_NONFUSED = _Anonymous_37.CUDNN_CONVOLUTION_FWD_ALGO_WINOGRAD_NONFUSED;
    enum CUDNN_CONVOLUTION_FWD_ALGO_COUNT = _Anonymous_37.CUDNN_CONVOLUTION_FWD_ALGO_COUNT;
    ...
    alias cudnnConvolutionBwdFilterPreference_t = _Anonymous_38;
    enum _Anonymous_38
    {
    ...
    enum CUDNN_CONVOLUTION_BWD_FILTER_NO_WORKSPACE = _Anonymous_38.CUDNN_CONVOLUTION_BWD_FILTER_NO_WORKSPACE;
    enum CUDNN_CONVOLUTION_BWD_FILTER_PREFER_FASTEST = _Anonymous_38.CUDNN_CONVOLUTION_BWD_FILTER_PREFER_FASTEST;
    enum CUDNN_CONVOLUTION_BWD_FILTER_SPECIFY_WORKSPACE_LIMIT = _Anonymous_38.CUDNN_CONVOLUTION_BWD_FILTER_SPECIFY_WORKSPACE_LIMIT;
    alias cudnnConvolutionBwdFilterAlgo_t = _Anonymous_39;
    enum _Anonymous_39
    {
    ...
    enum CUDNN_CONVOLUTION_BWD_FILTER_ALGO_0 = _Anonymous_39.CUDNN_CONVOLUTION_BWD_FILTER_ALGO_0;
    enum CUDNN_CONVOLUTION_BWD_FILTER_ALGO_1 = _Anonymous_39.CUDNN_CONVOLUTION_BWD_FILTER_ALGO_1;
    enum CUDNN_CONVOLUTION_BWD_FILTER_ALGO_FFT = _Anonymous_39.CUDNN_CONVOLUTION_BWD_FILTER_ALGO_FFT;
    enum CUDNN_CONVOLUTION_BWD_FILTER_ALGO_3 = _Anonymous_39.CUDNN_CONVOLUTION_BWD_FILTER_ALGO_3;
    enum CUDNN_CONVOLUTION_BWD_FILTER_ALGO_WINOGRAD = _Anonymous_39.CUDNN_CONVOLUTION_BWD_FILTER_ALGO_WINOGRAD;
    enum CUDNN_CONVOLUTION_BWD_FILTER_ALGO_WINOGRAD_NONFUSED = _Anonymous_39.CUDNN_CONVOLUTION_BWD_FILTER_ALGO_WINOGRAD_NONFUSED;
    enum CUDNN_CONVOLUTION_BWD_FILTER_ALGO_FFT_TILING = _Anonymous_39.CUDNN_CONVOLUTION_BWD_FILTER_ALGO_FFT_TILING;
    enum CUDNN_CONVOLUTION_BWD_FILTER_ALGO_COUNT = _Anonymous_39.CUDNN_CONVOLUTION_BWD_FILTER_ALGO_COUNT;
    ...
    alias cudnnConvolutionBwdDataPreference_t = _Anonymous_40;
    enum _Anonymous_40
    {
    ...
    enum CUDNN_CONVOLUTION_BWD_DATA_NO_WORKSPACE = _Anonymous_40.CUDNN_CONVOLUTION_BWD_DATA_NO_WORKSPACE;
    enum CUDNN_CONVOLUTION_BWD_DATA_PREFER_FASTEST = _Anonymous_40.CUDNN_CONVOLUTION_BWD_DATA_PREFER_FASTEST;
    enum CUDNN_CONVOLUTION_BWD_DATA_SPECIFY_WORKSPACE_LIMIT = _Anonymous_40.CUDNN_CONVOLUTION_BWD_DATA_SPECIFY_WORKSPACE_LIMIT;
    alias cudnnConvolutionBwdDataAlgo_t = _Anonymous_41;
    enum _Anonymous_41
    {
    ...
    enum CUDNN_CONVOLUTION_BWD_DATA_ALGO_0 = _Anonymous_41.CUDNN_CONVOLUTION_BWD_DATA_ALGO_0;
    enum CUDNN_CONVOLUTION_BWD_DATA_ALGO_1 = _Anonymous_41.CUDNN_CONVOLUTION_BWD_DATA_ALGO_1;
    enum CUDNN_CONVOLUTION_BWD_DATA_ALGO_FFT = _Anonymous_41.CUDNN_CONVOLUTION_BWD_DATA_ALGO_FFT;
    enum CUDNN_CONVOLUTION_BWD_DATA_ALGO_FFT_TILING = _Anonymous_41.CUDNN_CONVOLUTION_BWD_DATA_ALGO_FFT_TILING;
    enum CUDNN_CONVOLUTION_BWD_DATA_ALGO_WINOGRAD = _Anonymous_41.CUDNN_CONVOLUTION_BWD_DATA_ALGO_WINOGRAD;
    enum CUDNN_CONVOLUTION_BWD_DATA_ALGO_WINOGRAD_NONFUSED = _Anonymous_41.CUDNN_CONVOLUTION_BWD_DATA_ALGO_WINOGRAD_NONFUSED;
    enum CUDNN_CONVOLUTION_BWD_DATA_ALGO_COUNT = _Anonymous_41.CUDNN_CONVOLUTION_BWD_DATA_ALGO_COUNT;
    ...
    alias cudnnSoftmaxAlgorithm_t = _Anonymous_42;
    enum _Anonymous_42
    {
    ...
    enum CUDNN_SOFTMAX_FAST = _Anonymous_42.CUDNN_SOFTMAX_FAST;
    enum CUDNN_SOFTMAX_ACCURATE = _Anonymous_42.CUDNN_SOFTMAX_ACCURATE;
    enum CUDNN_SOFTMAX_LOG = _Anonymous_42.CUDNN_SOFTMAX_LOG;
    alias cudnnSoftmaxMode_t = _Anonymous_43;
    enum _Anonymous_43
    {
        CUDNN_SOFTMAX_MODE_INSTANCE = 0,
        CUDNN_SOFTMAX_MODE_CHANNEL = 1,
    }
    enum CUDNN_SOFTMAX_MODE_INSTANCE = _Anonymous_43.CUDNN_SOFTMAX_MODE_INSTANCE;
    enum CUDNN_SOFTMAX_MODE_CHANNEL = _Anonymous_43.CUDNN_SOFTMAX_MODE_CHANNEL;
    ...
    alias cudnnPoolingMode_t = _Anonymous_44;
    enum _Anonymous_44
    {
        CUDNN_POOLING_MAX = 0,
    ...
    enum CUDNN_POOLING_MAX = _Anonymous_44.CUDNN_POOLING_MAX;
    enum CUDNN_POOLING_AVERAGE_COUNT_INCLUDE_PADDING = _Anonymous_44.CUDNN_POOLING_AVERAGE_COUNT_INCLUDE_PADDING;
    enum CUDNN_POOLING_AVERAGE_COUNT_EXCLUDE_PADDING = _Anonymous_44.CUDNN_POOLING_AVERAGE_COUNT_EXCLUDE_PADDING;
    enum CUDNN_POOLING_MAX_DETERMINISTIC = _Anonymous_44.CUDNN_POOLING_MAX_DETERMINISTIC;
    ...
    alias cudnnActivationMode_t = _Anonymous_45;
    enum _Anonymous_45
    {
    ...
    enum CUDNN_ACTIVATION_SIGMOID = _Anonymous_45.CUDNN_ACTIVATION_SIGMOID;
    enum CUDNN_ACTIVATION_RELU = _Anonymous_45.CUDNN_ACTIVATION_RELU;
    enum CUDNN_ACTIVATION_TANH = _Anonymous_45.CUDNN_ACTIVATION_TANH;
    enum CUDNN_ACTIVATION_CLIPPED_RELU = _Anonymous_45.CUDNN_ACTIVATION_CLIPPED_RELU;
    enum CUDNN_ACTIVATION_ELU = _Anonymous_45.CUDNN_ACTIVATION_ELU;
    enum CUDNN_ACTIVATION_IDENTITY = _Anonymous_45.CUDNN_ACTIVATION_IDENTITY;
    ...
    enum CUDNN_ATTN_QUERYMAP_ALL_TO_ONE = _Anonymous_46.CUDNN_ATTN_QUERYMAP_ALL_TO_ONE;
    enum CUDNN_ATTN_QUERYMAP_ONE_TO_ONE = _Anonymous_46.CUDNN_ATTN_QUERYMAP_ONE_TO_ONE;
    alias cudnnLRNMode_t = _Anonymous_47;
    enum _Anonymous_47
    {
        CUDNN_LRN_CROSS_CHANNEL_DIM1 = 0,
    }
    enum CUDNN_LRN_CROSS_CHANNEL_DIM1 = _Anonymous_47.CUDNN_LRN_CROSS_CHANNEL_DIM1;
    ...
    alias cudnnDivNormMode_t = _Anonymous_48;
    enum _Anonymous_48
    {
        CUDNN_DIVNORM_PRECOMPUTED_MEANS = 0,
    }
    enum CUDNN_DIVNORM_PRECOMPUTED_MEANS = _Anonymous_48.CUDNN_DIVNORM_PRECOMPUTED_MEANS;
    ...
    alias cudnnBatchNormMode_t = _Anonymous_49;
    enum _Anonymous_49
    {
    ...
    enum CUDNN_BATCHNORM_PER_ACTIVATION = _Anonymous_49.CUDNN_BATCHNORM_PER_ACTIVATION;
    enum CUDNN_BATCHNORM_SPATIAL = _Anonymous_49.CUDNN_BATCHNORM_SPATIAL;
    enum CUDNN_BATCHNORM_SPATIAL_PERSISTENT = _Anonymous_49.CUDNN_BATCHNORM_SPATIAL_PERSISTENT;
    alias cudnnAttnQueryMap_t = _Anonymous_46;
    cudnnStatus_t cudnnDeriveBNTensorDescriptor(cudnnTensorStruct*, const(cudnnTensorStruct*), cudnnBatchNormMode_t) @nogc nothrow;
    alias cudnnBatchNormOps_t = _Anonymous_50;
    enum _Anonymous_50
    {
    ...
    enum CUDNN_BATCHNORM_OPS_BN = _Anonymous_50.CUDNN_BATCHNORM_OPS_BN;
    enum CUDNN_BATCHNORM_OPS_BN_ACTIVATION = _Anonymous_50.CUDNN_BATCHNORM_OPS_BN_ACTIVATION;
    enum CUDNN_BATCHNORM_OPS_BN_ADD_ACTIVATION = _Anonymous_50.CUDNN_BATCHNORM_OPS_BN_ADD_ACTIVATION;
    ...
    alias cudnnSamplerType_t = _Anonymous_51;
    enum _Anonymous_51
    {
        CUDNN_SAMPLER_BILINEAR = 0,
    }
    enum CUDNN_SAMPLER_BILINEAR = _Anonymous_51.CUDNN_SAMPLER_BILINEAR;
    ...
    alias cudnnRNNAlgo_t = _Anonymous_52;
    enum _Anonymous_52
    {
    ...
    enum CUDNN_RNN_ALGO_STANDARD = _Anonymous_52.CUDNN_RNN_ALGO_STANDARD;
    enum CUDNN_RNN_ALGO_PERSIST_STATIC = _Anonymous_52.CUDNN_RNN_ALGO_PERSIST_STATIC;
    enum CUDNN_RNN_ALGO_PERSIST_DYNAMIC = _Anonymous_52.CUDNN_RNN_ALGO_PERSIST_DYNAMIC;
    enum CUDNN_RNN_ALGO_COUNT = _Anonymous_52.CUDNN_RNN_ALGO_COUNT;
    alias cudnnRNNMode_t = _Anonymous_53;
    enum _Anonymous_53
    {
        CUDNN_RNN_RELU = 0,
        CUDNN_RNN_TANH = 1,
    ...
    enum CUDNN_RNN_RELU = _Anonymous_53.CUDNN_RNN_RELU;
    enum CUDNN_RNN_TANH = _Anonymous_53.CUDNN_RNN_TANH;
    enum CUDNN_LSTM = _Anonymous_53.CUDNN_LSTM;
    enum CUDNN_GRU = _Anonymous_53.CUDNN_GRU;
    alias cudnnRNNBiasMode_t = _Anonymous_54;
    enum _Anonymous_54
    {
        CUDNN_RNN_NO_BIAS = 0,
    ...
    enum CUDNN_RNN_NO_BIAS = _Anonymous_54.CUDNN_RNN_NO_BIAS;
    enum CUDNN_RNN_SINGLE_INP_BIAS = _Anonymous_54.CUDNN_RNN_SINGLE_INP_BIAS;
    enum CUDNN_RNN_DOUBLE_BIAS = _Anonymous_54.CUDNN_RNN_DOUBLE_BIAS;
    enum CUDNN_RNN_SINGLE_REC_BIAS = _Anonymous_54.CUDNN_RNN_SINGLE_REC_BIAS;
    alias cudnnDirectionMode_t = _Anonymous_55;
    enum _Anonymous_55
    {
        CUDNN_UNIDIRECTIONAL = 0,
        CUDNN_BIDIRECTIONAL = 1,
    }
    enum CUDNN_UNIDIRECTIONAL = _Anonymous_55.CUDNN_UNIDIRECTIONAL;
    enum CUDNN_BIDIRECTIONAL = _Anonymous_55.CUDNN_BIDIRECTIONAL;
    alias cudnnRNNInputMode_t = _Anonymous_56;
    enum _Anonymous_56
    {
        CUDNN_LINEAR_INPUT = 0,
        CUDNN_SKIP_INPUT = 1,
    }
    enum CUDNN_LINEAR_INPUT = _Anonymous_56.CUDNN_LINEAR_INPUT;
    enum CUDNN_SKIP_INPUT = _Anonymous_56.CUDNN_SKIP_INPUT;
    alias cudnnRNNClipMode_t = _Anonymous_57;
    enum _Anonymous_57
    {
        CUDNN_RNN_CLIP_NONE = 0,
        CUDNN_RNN_CLIP_MINMAX = 1,
    }
    enum CUDNN_RNN_CLIP_NONE = _Anonymous_57.CUDNN_RNN_CLIP_NONE;
    enum CUDNN_RNN_CLIP_MINMAX = _Anonymous_57.CUDNN_RNN_CLIP_MINMAX;
    alias cudnnRNNDataLayout_t = _Anonymous_58;
    enum _Anonymous_58
    {
    ...
    enum CUDNN_RNN_DATA_LAYOUT_SEQ_MAJOR_UNPACKED = _Anonymous_58.CUDNN_RNN_DATA_LAYOUT_SEQ_MAJOR_UNPACKED;
    enum CUDNN_RNN_DATA_LAYOUT_SEQ_MAJOR_PACKED = _Anonymous_58.CUDNN_RNN_DATA_LAYOUT_SEQ_MAJOR_PACKED;
    enum CUDNN_RNN_DATA_LAYOUT_BATCH_MAJOR_UNPACKED = _Anonymous_58.CUDNN_RNN_DATA_LAYOUT_BATCH_MAJOR_UNPACKED;
    alias cudnnRNNPaddingMode_t = _Anonymous_59;
    enum _Anonymous_59
    {
        CUDNN_RNN_PADDED_IO_DISABLED = 0,
        CUDNN_RNN_PADDED_IO_ENABLED = 1,
    }
    enum CUDNN_RNN_PADDED_IO_DISABLED = _Anonymous_59.CUDNN_RNN_PADDED_IO_DISABLED;
    enum CUDNN_RNN_PADDED_IO_ENABLED = _Anonymous_59.CUDNN_RNN_PADDED_IO_ENABLED;
    ...
    alias cudnnSeqDataAxis_t = _Anonymous_60;
    enum _Anonymous_60
    {
    ...
    enum CUDNN_SEQDATA_TIME_DIM = _Anonymous_60.CUDNN_SEQDATA_TIME_DIM;
    enum CUDNN_SEQDATA_BATCH_DIM = _Anonymous_60.CUDNN_SEQDATA_BATCH_DIM;
    enum CUDNN_SEQDATA_BEAM_DIM = _Anonymous_60.CUDNN_SEQDATA_BEAM_DIM;
    enum CUDNN_SEQDATA_VECT_DIM = _Anonymous_60.CUDNN_SEQDATA_VECT_DIM;
    ...
    static if(!is(typeof(CUDNN_SEQDATA_DIM_COUNT))) {
        enum CUDNN_SEQDATA_DIM_COUNT = 4;
    }
